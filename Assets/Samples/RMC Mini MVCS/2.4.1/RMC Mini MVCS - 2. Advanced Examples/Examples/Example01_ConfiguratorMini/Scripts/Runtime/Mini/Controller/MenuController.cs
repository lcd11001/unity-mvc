...
namespace RMC.MiniMvcs.Samples.Configurator.Mini.Controller
{
        ...
        <ConfiguratorModel, MenuView, ConfiguratorService> 
    {
        ...
        private void View_OnPlay()
        {
            ...
            Context.CommandManager.InvokeCommand(new SceneSystemLoadSceneCommand(ConfiguratorModel.Scene04_Game));
        }
        ...
        {
            RequireIsInitialized();
            Context.CommandManager.InvokeCommand(new SceneSystemLoadSceneCommand(ConfiguratorModel.Scene02_CustomizeCharacter));
        }
        ...
        {
            RequireIsInitialized();
            Context.CommandManager.InvokeCommand(new SceneSystemLoadSceneCommand(ConfiguratorModel.Scene03_CustomizeEnvironment));
        }
